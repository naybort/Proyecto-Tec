...
namespace SistemaHorasConsulta.Controllers
{
    public class CitasController : Controller
    {
        ...
        public ActionResult CitasPendientes()
        {
            NCita cita = new NCita();
            var citas = cita.getCitas();
            return View(citas.Where(x => x.Estado == "Pendiete"));
        }
        ...
        public ActionResult Create([Bind(Include = "IdCita,Fecha,HoraInicio,Estado")] Cita cita)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "IdCita,Fecha,HoraInicio,Estado")] Cita cita)
        {
            if (ModelState.IsValid)
            {
